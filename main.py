...
def main():
    if len(sys.argv) < 2:
        ...
        if len(sys.argv) < 11:
            ...
            sys.exit(1)
        train(int(sys.argv[2]), int(sys.argv[3]), int(sys.argv[4]), int(sys.argv[5]), int(sys.argv[6]), int(sys.argv[7]), int(sys.argv[8]), int(sys.argv[9]), float(sys.argv[10]), int(sys.argv[11]))
        pass
